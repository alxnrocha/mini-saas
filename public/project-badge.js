(function () {
  const projectName = 'ClientPulse SaaS';
  const projectUrl = 'https://alxnrocha.github.io/mini-saas/';
  const description = 'Gesṭo de Clientes, Projetos e Faturamento B2B';
